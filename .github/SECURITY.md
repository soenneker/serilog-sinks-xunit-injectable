...
Instead, report it privately using this repository�s [GitHub private vulnerability reporting tool](https://github.com/soenneker/serilog.sinks.xunit.injectable/security/advisories/new).
